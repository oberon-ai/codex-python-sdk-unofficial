...
def render_server_request_registry() -> str:
    ...
    return (
        "# generated by scripts/generate_protocol_models.py:\n"
        "#   source: derived upstream server-request method inventory + "
...
def write_server_request_registry() -> None:
...
def verify_server_request_registry() -> None:
    server_request_registry_text = render_server_request_registry()
